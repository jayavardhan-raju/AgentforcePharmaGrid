# AgentforcePharmaGrid Auth Broker
...
3. Set Worker secrets:
   ...
   `GITHUB_TOKEN` must be a fine-grained GitHub token with permission to call `repository_dispatch` on `jayavardhan-raju/AgentforcePharmaGrid`.
